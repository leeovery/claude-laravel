...
**Related guides:**
- [dtos.md](dtos.md) - Typed DTOs with property promotion
- [actions.md](actions.md) - Typed action parameters and returns
- [models.md](models.md) - Model casts and property types
