...
**Related guides:**
- [controllers.md](controllers.md) - Controllers use form requests
- [dtos.md](dtos.md) - Transformers convert validated requests to DTOs
...
- [quality.md](quality.md) - Testing standards and practices
